...
public static void main(String[] args) throws Throwable{
		ExcelFileUtil xl= new ExcelFileUtil("F:\\secondclass\\DDT_Framework\\TestInput\\Orange.xlsx");
		...
		for (int i = 1; i <= rc; i++) {
			...
			//xl.SetCellValue("F://Results.xlsx", "Login", i, 2, "Pass");
			//xl.SetCellValue("Login", i, 2, "fail", "F:\\secondclass\\DDT_Framework\\TestOutput\\Results.xlsx");
			xl.SetCellValue("Login", i, 2, "blocked", "F:\\secondclass\\DDT_Framework\\TestOutput\\Results.xlsx");
